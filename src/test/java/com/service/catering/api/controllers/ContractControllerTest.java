...
public class ContractControllerTest {
    ...
    @MockitoBean
    private ContractService contractService; // Mock del servicio
    ...
    void testNewContract_Success() throws Exception {
        ...
        String bodyRequest = "{\"description\":\"contrato de catering por 10 meses\",\"cateringPlan\":{\"id\":\"{{$guid}}\"},\"customer\":{\"id\":\"c9d4ac7b-657c-4dd4-87a8-fe02887e2563\"},\"totalAmount\":\"5000\",\"quotas\":\"5\"}";
        // Simular llamada HTTP POST al endpoint
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/catering/contract")
    ...
    void testNewContract_WhenExceptionThrown() throws Exception {
        ...
        doThrow(new RuntimeException("Error al procesar contrato")).when(contractService)
    ...
    void testGetContracts_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/catering/contracts"))
                .andExpect(status().isOk());
    ...
    void testGetContractId_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/catering/contract/" + contractDto.id))
                .andExpect(status().isOk());
    ...
    void testGetContractId_WhenExceptionThrown() throws Exception {
        ...
        doThrow(new RuntimeException("Error al procesar contrato")).when(contractService).getContract( anyString());
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/catering/contract/" + contractDto.id))
                .andExpect(status().isInternalServerError());
