...
public class PaymentServiceTest {
  ...
  @Mock private IOrderServiceUpdateStatus iOrderServiceUpdateStatus;

  @Mock private IBillerDataServiceUpdateData iBillerDataServiceUpdateData;

  @Mock private IInvoiceServiceGenerate iInvoiceServiceGenerate;
  ...
  public void testNewPayment() throws Exception {
    ...
    doNothing()
        .when(iBillerDataServiceUpdateData)
        .updateBillerData(
    ...
    try (MockedStatic<PaymentUtil> mockedStatic = mockStatic(PaymentUtil.class)) {
      mockedStatic
          .when(() -> PaymentUtil.paymentDtoToPaymentEntity(paymentDto))
  ...
  public void testGetPayments() {
    ...
    try (MockedStatic<PaymentUtil> mockedStatic = mockStatic(PaymentUtil.class)) {
      ...
      // Verificar que el método estático se llamó correctamente
      //            mockedStatic.verify(() -> PaymentUtil.paymentDtoToPaymentEntity(paymentDto),
      // times(1));
      // Verificar que se creó un evento con los datos correctos
