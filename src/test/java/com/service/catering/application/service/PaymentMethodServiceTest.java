...
public class PaymentMethodServiceTest {
  ...
  @Mock private IQueryPaymentMethodRepository iQueryPaymentMethodRepository;
  ...
  public void testNewPaymentMethod() throws Exception {
    ...
    try (MockedStatic<PaymentMethodUtil> mockedStatic = mockStatic(PaymentMethodUtil.class)) {
      mockedStatic
          .when(() -> PaymentMethodUtil.paymentMethodDtoToPaymentMethodEntity(paymentMethodDto))
  ...
  public void testGetPaymentMethods() throws Exception {
    ...
    try (MockedStatic<PaymentMethodUtil> mockedStatic = mockStatic(PaymentMethodUtil.class)) {
      mockedStatic
          .when(() -> PaymentMethodUtil.paymentEntityToPaymentMethodDto(paymentMethodEntity))
