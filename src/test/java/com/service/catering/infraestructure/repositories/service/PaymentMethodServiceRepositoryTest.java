...
public class PaymentMethodServiceRepositoryTest {
  ...
  public void test() {
    ...
    Mockito.when(paymentMethodRepository.save(Mockito.any(PaymentMethodEntity.class)))
        .thenReturn(paymentMethodEntityMock);
    ...
    Assertions.assertEquals(
        paymentMethodEntityMock, listResult.getFirst(), "objeto de la lista es igual al mock");
  }
}
