...
public class NutritionalPlanService extends BaseCommandHandler {
  ...
  @Autowired private IQueryNutritionalPlanRepository iQueryNutritionalPlanRepository;

  public NutritionalPlanDto newNutritionalPlan(NutritionalPlanDto nutritionalPlanDto)
      throws Exception {
    NutritionalPlanEntity nutritionalPlanEntity =
        NutritionalPlanUtil.nutritionalPlanDtoToNutritionalPlanEntity(nutritionalPlanDto);
  ...
  public List<NutritionalPlanDto> getNutritionalPlan() throws Exception {
    List<NutritionalPlanEntity> nutritionalPlanDtoList =
        iQueryNutritionalPlanRepository.queryNutritionalPlan();
    ...
    for (NutritionalPlanEntity nutritionalPlanEntity : nutritionalPlanDtoList) {
      nutritionalPlanDtos.add(
          NutritionalPlanUtil.nutritionalPlanEntityToNutritionalPlanDto(nutritionalPlanEntity));
    }
